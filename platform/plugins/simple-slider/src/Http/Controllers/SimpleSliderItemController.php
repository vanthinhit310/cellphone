...
namespace Platform\SimpleSlider\Http\Controllers;
...
use Platform\SimpleSlider\Forms\SimpleSliderItemForm;
use Platform\SimpleSlider\Http\Requests\SimpleSliderItemRequest;
