...
Route::group(['namespace' => 'Platform\Ecommerce\Http\Controllers', 'middleware' => ['web', 'core']], function () {
...
Route::group(['namespace' => 'Platform\Ecommerce\Http\Controllers\Fronts', 'middleware' => ['web', 'core', 'customer']], function () {
