...
use Platform\Ecommerce\Http\Requests\StoreLocatorRequest;
use Platform\Ecommerce\Http\Requests\UpdatePrimaryStoreRequest;
use Platform\Ecommerce\Http\Requests\UpdateSettingsRequest;
...
use Platform\Ecommerce\Services\StoreCurrenciesService;
