...
use Platform\Ecommerce\Http\Requests\AvatarRequest;
use Platform\Ecommerce\Http\Requests\EditAccountRequest;
use Platform\Ecommerce\Http\Requests\UpdatePasswordRequest;
