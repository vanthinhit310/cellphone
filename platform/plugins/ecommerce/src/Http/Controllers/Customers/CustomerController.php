...
use Platform\Ecommerce\Forms\CustomerForm;
use Platform\Ecommerce\Http\Requests\AddCustomerWhenCreateOrderRequest;
use Platform\Ecommerce\Http\Requests\CustomerCreateRequest;
use Platform\Ecommerce\Http\Requests\CustomerEditRequest;
use Platform\Ecommerce\Http\Requests\CustomerUpdateEmailRequest;
...
use Platform\Ecommerce\Tables\CustomerTable;
use Exception;
