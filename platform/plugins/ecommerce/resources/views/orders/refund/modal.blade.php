...
<div class="next-form-section">
    <div class="next-form-grid">
        <div class="next-form-grid-cell">
            ...
            <div class="table-wrap p-none">
                <table class="refund-totals">
                    ...
                    <tr>
                        ...
                        <td class="text-right quantity text-no-bold">
                            @if ($order->payment->status == \Platform\Payment\Enums\PaymentStatusEnum::PENDING)
            ...
            @if ($order->payment->status !== \Platform\Payment\Enums\PaymentStatusEnum::PENDING && ($order->payment->amount - $order->payment->refunded_amount) > 0)
