                                ...
                                @foreach ($shipping as $shippingItem)
                                    <div class="wrap-table-shipping-{{ $shippingItem->id }}">
                                        <div class="pd-all-20 p-none-b">
                                            <label class="p-none-r">{{ trans('plugins/ecommerce::shipping.country') }}: <strong>{{ Arr::get(\Platform\Base\Supports\Helper::countries(), $shippingItem->title, $shippingItem->title) }}</strong></label>
