                        ...
                        <div class="form-group mb0">
                            ...
                            <div class="ui-select-wrapper">
                                <select name="store_country" class="ui-select" id="store_country">
                                    @foreach(['' => trans('plugins/ecommerce::ecommerce.setting.select_country')] + \Platform\Base\Supports\Helper::countries() as $countryCode => $countryName)
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group form-group-no-margin">
                                <div class="multi-choices-widget list-item-checkbox">
                                    <ul>
                                        @foreach (\Platform\Base\Supports\Helper::countries() as $key => $item)
                                            <li>
                                                <input type="checkbox"
