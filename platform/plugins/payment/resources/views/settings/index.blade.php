                ...
                <div class="col-md-9">
                    ...
                    <div class="wrapper-content pd-all-20">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::customSelect('default_payment_method', \Platform\Payment\Enums\PaymentMethodEnum::labels(), setting('default_payment_method', Platform\Payment\Enums\PaymentMethodEnum::STRIPE)) !!}
                        </div>
                    ...
                    <table class="table payment-method-item">
                        ...
                        <tr class="paypal-online-payment payment-content-item hidden">
                            <td class="border-left" colspan="3">
                                {!! Form::open() !!}
                                {!! Form::hidden('type', \Platform\Payment\Enums\PaymentMethodEnum::STRIPE, ['class' => 'payment_type']) !!}
                                <div class="row">
                                    <div class="col-sm-6">
                                        <ul>
                                            <li>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="well bg-white">
                                            ...
                                            <div class="form-group">
                                                <label class="text-title-field" for="payment_stripe_description">{{ __('Description') }}</label>
                    ...
                    <table class="table payment-method-item">
                        ...
                        <tr class="paypal-online-payment payment-content-item hidden">
                            <td class="border-left" colspan="3">
                                {!! Form::open() !!}
                                {!! Form::hidden('type', \Platform\Payment\Enums\PaymentMethodEnum::PAYPAL, ['class' => 'payment_type']) !!}
                                <div class="row">
                                    <div class="col-sm-6">
                                        <ul>
                                            <li>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="well bg-white">
                                            ...
                                            <div class="form-group">
                                                <label class="text-title-field" for="payment_paypal_description">{{ __('Description') }}</label>
                    ...
                    <table class="table payment-method-item">
                            ...
                            <td colspan="3">
                                <div class="float-left" style="margin-top: 5px;">
                                    <div class="payment-name-label-group">
                                        @if ($codStatus != 0)<span class="payment-note v-a-t">{{ trans('plugins/payment::payment.use') }}:</span>@endif <label class="ws-nm inline-display method-name-label">{{ setting('payment_cod_name', \Platform\Payment\Enums\PaymentMethodEnum::COD()->label()) }}</label>
                                    </div>
                                </div>
                                <div class="float-right">
                                ...
                                <div class="col-sm-12">
                                    <div class="well bg-white">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="next-input" name="payment_cod_name" id="payment_cod_name" data-counter="400" value="{{ setting('payment_cod_name', \Platform\Payment\Enums\PaymentMethodEnum::COD()->label()) }}">
                                        </div>
                                        <div class="form-group">
                        ...
                        <tr class="bg-white">
                            <td colspan="3">
                                <div class="float-left" style="margin-top: 5px;">
                                    <div class="payment-name-label-group">
                                        @if ($bankTransferStatus != 0) <span class="payment-note v-a-t">{{ trans('plugins/payment::payment.use') }}:</span>@endif <label class="ws-nm inline-display method-name-label">{{ setting('payment_bank_transfer_name', \Platform\Payment\Enums\PaymentMethodEnum::BANK_TRANSFER()->label()) }}</label>
                                    </div>
                                </div>
                                <div class="float-right">
                                ...
                                <div class="col-sm-12">
                                    <div class="well bg-white">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="next-input" name="payment_bank_transfer_name" id="payment_bank_transfer_name" data-counter="400" value="{{ setting('payment_bank_transfer_name', \Platform\Payment\Enums\PaymentMethodEnum::BANK_TRANSFER()->label()) }}">
                                        </div>
                                        <div class="form-group">
