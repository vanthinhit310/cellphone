        ...
        <div class="flexbox-annotated-section">
            ...
            <div class="flexbox-annotated-section-content">
                <div class="wrapper-content pd-all-20">
                    <div class="form-group">
                        ...
                        <div class="ui-select-wrapper">
                            <select name="media_driver" class="ui-select setting-select-options" id="media_driver">
                                ...
                                <option value="google" @if (config('filesystems.default') === 'google') selected @endif>Google Driver</option>
                            </select>
                    ...
                    <!--Google Driver Media-->
                    <div data-type="google" class="setting-wrapper @if (setting('media_driver', config('filesystems.default')) !== 'google') hidden @endif">
                        <div class="form-group">
                            <label class="text-title-field"
                                for="media_google_driver_client_id">Google Driver Client ID</label>
                            <input type="text" class="next-input" name="media_google_driver_client_id" id="media_google_driver_client_id"
                                value="{{ config('filesystems.disks.google.clientId') }}" placeholder="Google Driver Client ID">
                        </div>
                        <div class="form-group">
                            <label class="text-title-field"
                                for="media_google_driver_client_secret">Google Driver Client Secret</label>
                            <input type="text" class="next-input" name="media_google_driver_client_secret" id="media_google_driver_client_secret"
                                value="{{ config('filesystems.disks.google.clientSecret') }}" placeholder="Google Driver Client Secret">
                        </div>
                        <div class="form-group">
                            <label class="text-title-field"
                                for="media_google_driver_refresh_token">Google Driver Refresh Token</label>
                            <input type="text" class="next-input" name="media_google_driver_refresh_token" id="media_google_driver_refresh_token"
                                value="{{ config('filesystems.disks.google.refreshToken') }}" placeholder="Google Driver Refresh Token">
                        </div>
                        <div class="form-group" style="margin-bottom: 1rem;">
                            <label class="text-title-field"
                                for="media_google_driver_folder_id">Google Driver Folder ID</label>
                            <input type="text" class="next-input" name="media_google_driver_folder_id" id="media_google_driver_folder_id"
                                value="{{ config('filesystems.disks.google.folderId') }}" placeholder="Google driver folder id">
                        </div>
                    </div>
                    <!--Google Driver Media-->
